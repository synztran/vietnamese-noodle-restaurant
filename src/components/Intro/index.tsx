...
export default function Introduction() {
	return (
		<div className="grid grid-cols-2 gap-4">
			<div className="col-span-1 sm:col-span-2 xs:col-span-2 flex flex-col gap-4">
				<div className="rounded-[45px] bg-orange-500 px-6 py-2 text-white min-w-[100px] max-w-max sm:mx-auto xs:mx-auto">
					Quán mì địa phương của người Việt
				</div>
				<h2 className="text-[36px] text-white font-bold max-w-[80%] sm:max-w-[100%] xs:max-w-[100%]">
					Vietnamese Noodle <br /> Local's Restaurant
				</h2>
				<div
					className="text-white max-w-[80%] sm:max-w-[100%] xs:max-w-[100%]"
