...
export default function StaffBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full flex justify-around items-center px-6 pt-3 safe-bottom bg-stone-50/95 silk-blur shadow-[0_-4px_24px_rgba(126,0,10,0.06)] rounded-t-3xl z-50">
      <Link
        href="/"
